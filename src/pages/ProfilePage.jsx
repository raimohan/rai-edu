...
import { LogOut, User, Mail, BookOpen, Globe, Trash2, Save, EyeOff, UserPlus, UserCheck, UserX, MessageSquare } from 'lucide-react';
...
const ProfilePage = () => {
    ...
    if (isOwnProfile) {
        if (!editableProfileData) return <ProfileSkeleton />;
        return (
            <>
                <Card>
